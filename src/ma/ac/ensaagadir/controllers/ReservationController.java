...
public class ReservationController {
    ...
    @FXML
    private TableColumn<Reservation, String> matriculeVoiture;
	...
	private void initialize() {
		...
		matriculeVoiture.setCellValueFactory(cellData -> cellData.getValue().Voiture().get().NumImmatriculation());
    ...
    void clicked() {
		...
		edit.setDisable(true);
		delete.setDisable(true);
		session.setSelectedReservation(null);
    }
